  ...
  return (
    <div className="space-y-8">
      ...
      {state && !state.configured && (
        <div className="border rounded-lg p-5 bg-amber-50 text-sm text-amber-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {state.apps.map((app) => (
                <div key={app.domain} className="border rounded-lg p-5 space-y-3">
                  ...
                  <div className="font-mono text-sm text-gray-600">{app.domain}</div>
                  {app.policies.map((p) => (
                    <div key={p.name} className="text-sm">
                      ...
                      <span className="text-gray-700">{p.subjects.join(', ')}</span>
                    </div>
                  ))}
                </div>
              ))}
